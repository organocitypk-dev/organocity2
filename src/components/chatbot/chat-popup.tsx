...
export function ChatPopup({ open, onClose }: { open: boolean; onClose: () => void }) {
  const [messages, setMessages] = useState<Msg[]>([
    {
      role: "assistant",
      content:
        "Hi! I am your OrganoCity AI assistant. Ask me about products, accessories, warranty support, or say 'I want to order'.",
    },
  ]);
  ...
  return (
    <div
      ref={popupRef}
      className={`fixed bottom-24 left-6 z-50 w-[360px] max-w-[calc(100vw-2rem)] overflow-hidden rounded-2xl border border-[#C6A24A]/20 bg-[#fcf5e8] shadow-2xl transition-all duration-300 ${

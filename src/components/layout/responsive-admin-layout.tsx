...
export function AdminMobileHeader({ admin }: { admin: any }) {
  ...
  return (
    <>
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between gap-4 border-b border-[#C6A24A]/20 bg-[#fcf5e8]/80 px-4 md:hidden backdrop-blur">
        <button
          type="button"
...
function AdminTopbarSimple() {
  return (
    <header className="flex h-16 items-center justify-between gap-4 border-b border-[#C6A24A]/20 bg-[#fcf5e8]/80 px-6 backdrop-blur">
      ...
      <div className="flex items-center gap-2">
        <Link
          href="/admin/profile"
          className="inline-flex items-center gap-2 rounded-lg border border-[#C6A24A]/25 bg-white px-3 py-2 text-sm font-medium text-[#0a0a0a] hover:bg-[#fcf5e8]"
        >
          <FiUser className="h-4 w-4" />
          <span>Profile</span>
        </Link>

                   ...
                   {cart.lines?.map((line, index) => (
                    <CartLineProvider key={line?.id} line={line!}>
                        ...
                        <div className="flex items-start gap-2 sm:gap-3">
                           <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-lg bg-[#fcf5e8] ring-1 ring-[#C6A24A]/20 shadow-sm transition-all hover:shadow-md sm:h-20 sm:w-20 sm:rounded-xl">
                            <Image
                             ...
                             <div className="flex flex-wrap gap-1">
                               ...
                               {line?.merchandise?.selectedOptions?.map((option) => (
                                 <Badge
                                   key={option?.name}
                                   variant="secondary"
                                   className="rounded-full border border-[#C6A24A]/20 bg-[#fcf5e8] px-1.5 py-0 text-[9px] font-medium text-[#0a0a0a] sm:px-2 sm:py-0.5 sm:text-[10px]"
                                 >
                                   {option?.value}
                                 </Badge>
                               ))}
                            ...
                            <div className="flex items-center justify-between gap-2">
                              <div className="flex items-center gap-1 sm:gap-2">
                                <button
                                  ...
                                  className="h-5 w-5 rounded-full border-2 border-[#C6A24A]/30 flex items-center justify-center text-[#5A5E55] transition-all hover:border-[#f6a45d] hover:bg-[#f6a45d] hover:text-white hover:scale-110 active:scale-95 text-[10px] sm:h-6 sm:w-6 sm:text-xs"
                                >

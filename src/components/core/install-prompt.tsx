    ...
    <div className="fixed bottom-4 left-4 right-4 z-50 md:left-auto md:right-4 md:max-w-sm">
      <div className="bg-[#1a1308] text-white rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="px-4 pb-4">
          <button
            onClick={installApp}
            className="w-full bg-[#C6A24A] hover:bg-[#b8923f] text-[#0a0a0a] font-semibold py-2.5 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors text-sm"
          >
